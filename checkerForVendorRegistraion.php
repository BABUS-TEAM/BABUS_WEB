...
<form id="upload-form" enctype="multipart/form-data">
	...
	<input type="hidden" name="companyname" value="mona">
	<input type="hidden" name="companypassword" value="123">
	...
	<input type="hidden" name="companyusername" value="m">
	<input type="hidden" name="companymoto" value="we win!">
	<input type="hidden" name="companyaddress" value="4kilo">
...
<script type="text/javascript">
	...
	form.onsubmit=function(event){
		...
		for(var i=0;i<files.length;i++){
			...
			var xhr=new XMLHttpRequest();
			// xhr.open('POST','registerTrainVendor',true);
